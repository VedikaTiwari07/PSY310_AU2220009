...
expName = 'Signal Detection Experiment'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\vedik\\OneDrive\\Desktop\\AU\\PSY310 Lab\\Signal Detection Experiment_lastrun.py',
