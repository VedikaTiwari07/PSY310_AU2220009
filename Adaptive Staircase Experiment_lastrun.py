...
expName = 'Adaptive Staircase Experiment'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\vedik\\OneDrive\\Desktop\\AU\\PSY310 Lab\\Adaptive Staircase Experiment_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    grating = visual.GratingStim(
        ...
        ori=1.0, pos=(0, 0), size=(0.3, 0.3), sf=8.0, phase=0.0,
    ...
    # --------Prepare to start Staircase "staircase" --------
    # set up handler to look after next chosen value etc
    staircase = data.StairHandler(startVal=10.0, extraInfo=expInfo,
        stepSizes=[2,1,1,0.5], stepType='lin',
        nReversals=0.0, nTrials=100.0, 
        nUp=1.0, nDown=3.0,
        minVal=1.0, maxVal=20.0,
        originPath=-1, name='staircase')
    thisExp.addLoop(staircase)  # add the loop to the experiment
    level = thisStaircase = 10.0  # initialise some vals
    ...
    for thisStaircase in staircase:
        ...
        # Run 'Begin Routine' code from fiftyfifty
        ...
        # Run 'End Routine' code from fiftyfifty
        thisExp.addData('corrAns' , corr_resp)
        thisExp.addData('tilt' , direction)
        ...
        # store data for staircase (StairHandler)
