...
expName = 'Word Priming Exp'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\vedik\\OneDrive\\Desktop\\AU\\PSY310 Lab\\Word Priming Exp\\Word Priming Exp_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('word priming conditions.csv'),
    ...
    trials_2 = data.TrialHandler(nReps=1.0, method='random', 
        extraInfo=expInfo, originPath=-1,
        trialList=data.importConditions('Word prinming cond2.csv'),
    ...
    for thisTrial_2 in trials_2:
        ...
        # keep track of which components have finished
        TestPhaseComponents = [TestText, test_textbox, submit_text, testmouse]
