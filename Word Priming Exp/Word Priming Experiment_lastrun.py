...
expName = 'Word Priming Experiment'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\vedik\\OneDrive\\Desktop\\AU\\PSY310 Lab\\Word Priming Exp\\Word Priming Experiment_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    Studyslider = visual.Slider(win=win, name='Studyslider',
        startValue=None, size=(0.-0.3), pos=(0, -0.4), units=win.units,
    ...
    trials_2 = data.TrialHandler(nReps=1.0, method='random', 
        ...
        trialList=data.importConditions('C:/Users/vedik/OneDrive/Desktop/AU/PSY310 Lab/Word Priming Exp/Word prinming cond2.csv'),
    ...
    for thisTrial_2 in trials_2:
        ...
        trials = data.TrialHandler(nReps=1.0, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions('C:/Users/vedik/OneDrive/Desktop/AU/PSY310 Lab/Word Priming Exp/word priming conditions.csv'),
