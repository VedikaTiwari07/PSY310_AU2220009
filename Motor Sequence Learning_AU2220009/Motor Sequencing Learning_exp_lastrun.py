...
expName = 'Motor Sequencing Learning_exp'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\vedik\\OneDrive\\Desktop\\AU\\PSY310 Lab\\MSL_exp\\Motor Sequencing Learning_exp_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    Fixation = visual.ShapeStim(
        ...
        lineWidth=1.0,     colorSpace='rgb',  lineColor=[-0.2549, 0.2392, 0.2549], fillColor='white',
    ...
    trials = data.TrialHandler(nReps=50.0, method='sequential', 
        ...
        trialList=data.importConditions('excel for motor sequence exp.csv'),
